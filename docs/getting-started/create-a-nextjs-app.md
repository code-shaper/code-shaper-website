...
This section provides basic instructions on generating a web application using
the Next.js plugin. We'll then show you how to extend this application using
additional generators and other popular libraries. The final application will
show a list of top 10 movies as shown below. You can find a completed example of
this application [here](https://github.com/code-shaper/movie-magic).
...
testing in
[React Testing Guidelines](https://github.com/nareshbhatia/react-testing-techniques).
